...
function DJIMap(container,initLatitude,initLongitude) {
    ...
    //for 2d purpose
    //camera.position.set(0,800,0); // left/right, reserve, up/down
    //camera.rotation.z = 0;
    ...
    */
    ...
    function loadMap(latitude, longitude, x, z){
        ...
        var tex = texloader.load("https://api.mapbox.com/v4/mapbox.streets/"+longitude+","+latitude+","+scale+"/512x512.png128?access_token=pk.eyJ1IjoibGFueXVzZWEiLCJhIjoiY2lpNnJtYzdoMDF1ZnRybTA0bTZlMmNtciJ9.9fKQNjEiRCCkSCXpMBWK1w");
