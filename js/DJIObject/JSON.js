...
var upload_mission_info = {
    ...
    "VALUE": 	{
        "LENGTH": 			0,//# of points
        "VEL_CMD_RANGE": 	5,//velocity range from RC
        "IDLE_VEL": 		3,
        "ACTION_ON_FINISH": 0,
        ...
        "GIMBAL_PITCH_MODE": 0,
        "GOTO_FIRST_FLAG": 0,
        "HP_LATI": 			0,//22.540091*Math.PI/180, //The home info should be set as the one in drone MCU
        "HP_LONTI": 		0,//113.946593*Math.PI/180,
        "HP_ALTI": 			0//100
    }
};
    ...
    "VALUE":     {
        ...
        "ACTION": {
            ...
            "COMMAND_LIST":	{
                ...
                "WP_ACTION_CRAFT_YAW": 0,
                "WP_ACTION_GIMBAL_PITCH": 0
            }
        }
